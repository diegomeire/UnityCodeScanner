...
char* MakeTesseractPhoto_iOS ( char* lang, char* charEncodeData) {
    ...
    NSArray *arrayG8PageIteratorLevelWord = [tesseract recognizedBlocksByIteratorLevel:G8PageIteratorLevelWord];
    
    NSString *result = [NSString string];
    for (G8RecognizedBlock *block in arrayG8PageIteratorLevelWord){
        result = [result stringByAppendingString:[NSString stringWithFormat:@"%f: ", block.confidence]];
